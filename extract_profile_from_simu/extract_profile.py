...
def main():
    ...
    target_ls = float(input('Select the ls for the extraction (max='+str(amax(data_ls))+'): '))
    ...
    directory_output = 'profiles_'+filename[:-3]+'_ls'+str(int(data_ls[idx_ls]))+'_lat'+str(int(data_latitude[
                                                                                                idx_latitude]))+'N/'
    try:
